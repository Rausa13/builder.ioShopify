  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        /* to allow live preview editing on local development*/
        custom404Dev: path.resolve('src/pages/404.js'),
        templates: {
          /* Render every `landingPage` model as a new page using the /page.tsx template
          /* based on the URL provided in Builder.io
          */
          landingPage: path.resolve('src/templates/LandingPage/index.js'),
        },
      },
    },
